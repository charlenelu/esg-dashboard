...
"[project]/src/repositories/company-risk-overview/companyRiskOverviewRepository.ts [app-rsc] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/services/company-risk-overview/companyRiskOverviewService.ts [app-rsc] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$repositories$2f$company$2d$risk$2d$overview$2f$companyRiskOverviewRepository$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/repositories/company-risk-overview/companyRiskOverviewRepository.ts [app-rsc] (ecmascript)");
...
class CompanyRiskOverviewService {
    async getRiskOverview(companyId) {
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$repositories$2f$company$2d$risk$2d$overview$2f$companyRiskOverviewRepository$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["companyRiskOverviewRepository"].findById(companyId);
            if (!data) {
    ...
    async getAllRiskOverviews() {
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$repositories$2f$company$2d$risk$2d$overview$2f$companyRiskOverviewRepository$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["companyRiskOverviewRepository"].findAll();
    ...
    formatRiskData(data) {
        return {
            ...
            lastUpdatedFormatted: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(data.lastUpdated), 'yyyy-MM-dd HH:mm:ss')
        };
    }
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$company$2d$risk$2d$overview$2f$companyRiskOverviewService$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/company-risk-overview/companyRiskOverviewService.ts [app-rsc] (ecmascript)");
;
;
;
async function CompanyRiskOverview() {
    ...
    let error = null;
    try {
        data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$company$2d$risk$2d$overview$2f$companyRiskOverviewService$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["companyRiskOverviewService"].getRiskOverview('demo-company-123');
    } catch (err) {
...
//# sourceMappingURL=_c2199107._.js.map